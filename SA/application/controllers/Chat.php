...
public function index()
	...
	public function enkripPesan()//proses mengenkripsi pesan
		{	
			$gabunganRumusKey 	= '';
			$kalimat			= 'Pasti Bisa';//kunci yang akan di gunakan proses enkrip
			$pesan				= 'saya bisa LULUS tepat waktu!? '; //pesan yang aka di enkrip
			...
			//tambahan|x|y|z|a|b|	
				...
				$hasilEknripsiakhir 		= array(); //mengubah biner ke ascii dan proses enkrip selesai
					...
					$klipatan8 							= 0;
					for ($i=0; $i <$panjangPesan ; $i++) { 
						$hasilbinner8bit[$i] 			= substr($gabunganHasilDecimal, $klipatan8, 8);//proses pemecahan biner manjadi 8 bit
